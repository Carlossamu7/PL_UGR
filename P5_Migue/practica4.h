...
//typedef enum {booleano, entero, real, caracter,array, desconocido, no_asignado} TipoDato; 	///ELIMINAR ENUM
...
Simbolo tipoArg(char * nombreFun,int numPar){
	int i,indiceFun;
	bool encontrada=false;
